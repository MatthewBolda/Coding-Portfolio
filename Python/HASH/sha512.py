...
# step 1: pad message to integral of 1024
# step 2: generate message schedule
# step 3: 80 round-based processes
# step 4: update hash value for previous message
...
def sha512(message, output):
    ...
    bv1 = message + BitVector(bitstring="1")
    length1 = bv1.length()
    howmanyzeros = ((448*2) - length1) % (512*2)
